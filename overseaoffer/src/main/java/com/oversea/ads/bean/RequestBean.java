...
public class RequestBean
{
    ...
    public OverseaPager getPager()
    {
        if (pager == null)
        {
            pager = OverseaPager.getPager(paramMap);
        }
        return pager;
    }
    ...
    public RequestBean(boolean check, String src)
    {
        this.check = check;
        this.src = src;
    }
    ...
    {
        if (OverseaStringUtil.isBlank(key))
        {
            return;
        }
