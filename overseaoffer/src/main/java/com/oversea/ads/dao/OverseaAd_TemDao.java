    ...
    public int insert_tem(final OverseaAd_Tem item)
    {
        ...
        sb
                .append(" (`type`,`provider`,`name`, `pkg`, `apk`, `country`,`ecountry`,"
                        + "`mainicon`, `visit`, `click`, `cap`, `object_cap`, `price`, `preweight`,`weight`,`pullratio`,`sinstall`,`status`, `offerid`,`is_onlypush`,`push_rate`,`is_exchange`,`createdate`,`updatedate`) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?,?, ?,?, ?,?,?,?,?, ?, ?,?,?,?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)");
