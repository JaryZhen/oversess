...
public class OverseaAdscend_media_api1_ymTran extends OverseaBaseTrans
{
    public static final Logger log = Logger.getLogger(OverseaAdscend_media_api1_ymTran.class);
