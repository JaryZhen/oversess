...
public class OverseaOfferBlackListDao extends OverseaBaseDao
{
    ...
    private static final String CACHE_KEY_ALL                 = OverseaOfferBlackListDao.class
                                                                      .getName()
                                                                      + "_all";
    private static final String CACHE_KEY_BLACKLIST                 = OverseaOfferBlackListDao.class
    .getName()
    + "_blacklist";
    ...
    {
        Object obj = OverseaCacheFactory.get(CACHE_KEY_BLACKLIST);
        ...
        else
        {
            ...
            OverseaCacheFactory.add(CACHE_KEY_BLACKLIST ,list,
